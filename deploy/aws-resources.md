...
- **Pre-Tier-2-departments snapshot**: RDS snapshot
  ...
  itself.
- **Pre-consents-certificates snapshot**: RDS snapshot
  `opd-care-db-pre-consents-certificates-20260926-1300` was taken just
  before migration `20260926112022_consents_certificates` ran in production
  (2026-09-26; additive: consent forms, medical certificates, a procedure's
  consent link, the CONSENT_FORM attachment category). Safe to delete once
  that release has proven itself.
